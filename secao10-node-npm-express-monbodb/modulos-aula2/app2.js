...
//utilizamos o path.resolve quando não sabemos qual o lugar que o script ou aplicação vai rodar, ele vai ajustar as barras e diretorios para que a aplicação execute corretamentes
